...
ASSET_GENERATED_SENTINEL = "__ASSET_GENERATED__"

class FileResult(Result):
    """Represents a file generated by a tool or agent"""
    value: str = ASSET_GENERATED_SENTINEL
    file_name: str 
    file_content: bytes
    ...
    def __init__(self, file_name: str, file_content: bytes, mime_type: str = None, **kwargs):
        super().__init__(
            value=ASSET_GENERATED_SENTINEL,
            file_name=file_name,
    ...
    def matches_sentinel(value) -> bool:
        return value == ASSET_GENERATED_SENTINEL

class AssetGenerated(Event):
    """Event indicating a file was generated"""
    def __init__(self, agent: str, file_name: str, mime_type: str, file_id: str, depth: int = 0):
        super().__init__(
            agent=agent,
    ...
    def file_name(self) -> str:
        return self.payload["file_name"]
    
    @property 
    def mime_type(self) -> str:
        return self.payload["mime_type"]
        
    @property
    def file_id(self) -> str:
        return self.payload["file_id"]
